...
function section4() {
  return (
    <section id='section4' className='parallax__item relative flex items-center justify-center w-full h-screen'>
      <span className="absolute bottom-5 right-5 text-[4vw] leading-none">04.가로</span>
        <div className='flex items-start justify-between gap-40 w-100'>
          <div className='flex-col items-start flex-1 gap-3'>
            ...
            <div className="block my-2 text-xl font-semibold text-gray-200">
              <span className="text-yellow-400">React</span> JavaScript HTML <span className="text-cyan-500">tailwind</span> CSS 
            </div>
            <p className="font-semibold text-base leading-relaxed block w-100 text-gray-500">
                <sapn className="text-gray-300 font-bold"> React, JSX 컴포넌트</sapn>를 활용한 UI 개발을 담당하여 서브 포지션으로<br/>
                프로젝트를 성공적으로 완성했으며,  <sapn className="text-gray-300 font-bold"> Tailwind CSS</sapn>를 사용해 <br/>일관된 디자인 시스템을 <span classname="text-gray-300 font-bold"> 구현했습니다.</span>
            </p>
          </div>
          {/* 왼쪽 컨탠츠 */}
